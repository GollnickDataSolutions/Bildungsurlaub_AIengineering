...
config_dict = {'EPOCHS': 200, 'BATCH_SIZE': 64, 'LR': 0.01, 'HIDDEN1': 64, 'HIDDEN2': 32, 'HIDDEN3': 32, 'HIDDEN4': 16, 'OPTIMIZER': 'Adam', 'DROPOUT': 0.1, 'USE_BATCHNORM': False, 'LR_SCHEDULER': 'ReduceLROnPlateau', 'WEIGHT_DECAY': 1e-05}
...
res_path = r"c:\Temp\Bildungsurlaub_AIengineering\unsere_skripte\autoresearch_results\iter3_lr_scheduler_results.json"
