...
class RegressionTorch(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        self.HIDDEN3 = 32
        self.HIDDEN4 = 16
        self.linear_0 = nn.Linear(in_features=input_size, out_features=64)
        self.relu_0 = nn.ReLU()
        self.dropout_0 = nn.Dropout(p=0.1)
        self.linear_1 = nn.Linear(in_features=64, out_features=32)
        self.relu_1 = nn.ReLU()
        self.dropout_1 = nn.Dropout(p=0.1)
        self.linear_2 = nn.Linear(in_features=32, out_features=32)
        self.relu_2 = nn.ReLU()
...
config_dict = {'EPOCHS': 200, 'BATCH_SIZE': 64, 'LR': 0.01, 'HIDDEN1': 64, 'HIDDEN2': 32, 'HIDDEN3': 32, 'HIDDEN4': 16, 'OPTIMIZER': 'SGD', 'MOMENTUM': 0.9, 'DROPOUT': 0.1, 'USE_BATCHNORM': False, 'LR_SCHEDULER': 'StepLR', 'WEIGHT_DECAY': 0.0001}
...
res_path = r"c:\Temp\Bildungsurlaub_AIengineering\unsere_skripte\autoresearch_results\iter5_sgd_momentum_results.json"
