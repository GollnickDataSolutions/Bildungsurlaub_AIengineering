...
#%% Tensorboard Writer
writer = SummaryWriter(log_dir="runs/reg_train1")
# %% Hyperparameter
EPOCHS = 100
BATCH_SIZE = 128
LR = 0.001
...
for epoch in range(EPOCHS):
    ...
    # Tensorboard Log
    writer.add_scalar("loss/val", loss_val.item()/len(val_loader), epoch)
...
# %% Tensorboard server starten (aus dem Ordner unsere_skripte starten)
